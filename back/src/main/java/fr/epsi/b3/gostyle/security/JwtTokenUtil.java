...
public class JwtTokenUtil {
    ...
    public Integer tokenExpire = 240;
    private String secret = "secret";

    // affect time to field JWT_TOKEN_VALIDITY
    public void getTokenExpirationTIme() {
        JwtTokenUtil.JWT_TOKEN_VALIDITY = tokenExpire * 60;
    }
    ...
    public HttpHeaders getTokenAsHeader(UserDetails userDetails) {
